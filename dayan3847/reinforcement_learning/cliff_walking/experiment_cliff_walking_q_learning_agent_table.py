...
from dayan3847.reinforcement_learning.cliff_walking.CliffWalkingQLearningAgentTable import \
    CliffWalkingQLearningAgentTable
...
if __name__ == '__main__':
    ...
    for _ex in range(EXPERIMENTS):
        ...
        ag = CliffWalkingQLearningAgentTable(
    ...
    np.savetxt('qlearning_reward.txt', reward_mean, delimiter=',')
    np.savetxt('qlearning_win.txt', win, delimiter=',')
